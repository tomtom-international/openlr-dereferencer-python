...
INSERT INTO nodes (id, coord) VALUES
    ...
    (5, MakePoint(13.4175, 52.521, {SRID})),
    ...
    (14, MakePoint(13.41, 52.5245, {SRID}));
...
INSERT INTO lines (startnode, endnode, frc, fow, path) VALUES
    ...
    (4, 5, 2, 3, ST_GeomFromText("LINESTRING(13.416 52.525, 13.4175 52.521)", {SRID})),
    (5, 7, 2, 3, ST_GeomFromText("LINESTRING(13.4175 52.521, 13.4185 52.525)", {SRID})),
