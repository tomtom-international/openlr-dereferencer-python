...
class DecoderObserver:
    ...
    def on_route_success(self, from_lrp: LocationReferencePoint, to_lrp: LocationReferencePoint, from_line: Line,
        ...
        "Called after the decoder successfully finds a route between 2 candidate lines for successive location reference points"

    @abstractmethod
    def on_route_fail(self, from_lrp: LocationReferencePoint, to_lrp: LocationReferencePoint, from_line: Line, to_line: Line):
        "Called after the decoder fails to find a route between 2 candidate lines for successive location reference points"
