...
from .bi_directional_candidate_search import bi_directional_search
...
def dereference_path(
    ...
    bi_directional_search(lrps, reader, config, observer)
...
def decode_line(reference: LineLocationReference, reader: MapReader, config: Config,
    ...
    dereference_path(reference.points, reader, config, observer)
